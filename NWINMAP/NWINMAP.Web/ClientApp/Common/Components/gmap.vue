    ...
    export default {
        ...
        data() {
            return {
                ...
                navigator: {},
                centerPosition: { lat: 113.842046, lng: 1120.943854 },
                map: {},
                marker: {},
                infoWindow: {},
                geocode: {}
        ...
        updated() {
            ...
            vm.items.forEach(item => {
                ...
                google.maps.event.addListener(marker, 'click', function (event) {
                    ...
                    //    lng: store.geoY,
                    //});
                    vm.$emit('onItemMarkerClicked', item);
                });

                vm.itemMarkers.push(marker);
            });
